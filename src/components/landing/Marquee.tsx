  ...
  return (
    <div className="w-full py-10 bg-[#050508] border-y border-white/5 relative overflow-hidden z-20">
      ...
      <div className="flex w-full">
        {/* Container 1 */}
        <div className="flex animate-marquee min-w-full shrink-0 items-center justify-around gap-16 pr-16 will-change-transform">
          {niches.map((niche, i) => (
            <div key={i} className="flex items-center gap-4 shrink-0 group">
              ...
              <span className="text-lg font-bold text-slate-400 group-hover:text-white transition-colors duration-300 uppercase tracking-widest">
                {niche}
              </span>
            </div>
          ))}
        ...
        <div className="flex animate-marquee min-w-full shrink-0 items-center justify-around gap-16 pr-16 will-change-transform" aria-hidden="true">
          {niches.map((niche, i) => (
