...
const Footer: React.FC = () => {
  ...
  return (
    <>
      <footer className="bg-[#020203] border-t border-white/10 py-10 px-4 md:px-12 relative z-30">
        <div className="container mx-auto max-w-7xl flex flex-col items-center gap-6">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            />
            <p className="text-xs text-slate-500 font-medium">Feito com 🧡 por <a href="https://agenciabenck.com" target="_blank" rel="noopener noreferrer" className="font-bold hover:text-orange-500 transition-colors">Agência Benck.</a></p>
          </div>
        ...
        <div className="container mx-auto max-w-4xl mt-8 pt-6 border-t border-white/5 flex flex-col items-center text-center gap-4">
          <p className="text-xs text-slate-600 leading-relaxed max-w-2xl font-normal">
            O beleadly é uma ferramenta independente de automação e inteligência de dados. Não possuímos afiliação, parceria ou endosso do Google Inc. ou Google Maps. Todas as marcas registradas mencionadas pertencem aos seus respectivos proprietários. O uso desta ferramenta deve estar em conformidade com as leis locais de proteção de dados.
          </p>
          <p className="text-slate-500 text-xs font-normal">© 2026 beleadly Inc. Todos os direitos reservados.</p>
        </div>
      </footer>
